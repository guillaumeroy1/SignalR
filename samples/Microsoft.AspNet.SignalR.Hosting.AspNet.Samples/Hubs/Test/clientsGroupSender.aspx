...
<asp:Content ID="Content2" ContentPlaceHolderID="Scripts" runat="server">
    ...
    <script src="clientsGroupSender.js"></script>
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <ul class="breadcrumb">
        ...
        <li class="active">Group Sender</li>
    </ul>
    <table>
        <tr>
            <td>Try other transports:</td>
            <td><a href="clientsGroupSender.aspx?transport=webSockets">webSockets</a></td>
            <td><a href="clientsGroupSender.aspx?transport=foreverFrame">foreverFrame</a></td>
